  ...
  _createClass(Webform, [{
      ...
      return new _nativePromiseOnly2.default(function (resolve, reject) {
        try {
          _i18next2.default.init(_this3.options.i18n, function (err) {
            ...
            _this3.options.language = _i18next2.default.language.split(';')[0];
            if (err) {
              return reject(err);
            }
    ...
    value: function showErrors(error, triggerEvent) {
      ...
      var message = '\n      <p>' + this.t('error') + '</p>\n      <ul>\n        ' + errors.map(function (err) {
        return err ? '<li><strong>' + (err.message || err) + '</strong></li>' : '';
      }).join('') + '\n      </ul>\n    ';
    ...
    value: function submitForm() {
      ...
      return new _nativePromiseOnly2.default(function (resolve, reject) {
        ...
        _lodash2.default.defaults(submission.metadata, {
          timezone: _lodash2.default.get(_this12, '_submission.metadata.timezone', (0, _utils.currentTimezone)()),
          offset: parseInt(_lodash2.default.get(_this12, '_submission.metadata.offset', (0, _moment2.default)().utcOffset()), 10),
