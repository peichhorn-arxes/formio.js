...
var Wizard = function (_Webform) {
  ...
  _createClass(Wizard, [{
    ...
    value: function getComponents() {
      return this.submitting ? this.getPages() : _get(Wizard.prototype.__proto__ || Object.getPrototypeOf(Wizard.prototype), 'getComponents', this).call(this);
    }
  }, {
    key: 'resetValue',
    ...
    value: function beforeSubmit() {
      return _nativePromiseOnly2.default.all(this.getPages().map(function (page) {
    ...
    value: function buildWizardHeader() {
      ...
      this.pages.forEach(function (page, i) {
        ...
        var clickable = i <= _this7.page + 1 && _this7.options.breadcrumbSettings.clickable;
        ...
        if (clickable) {
          _this7.addEventListener(pageButton, 'click', function (event) {
            ...
            if (i <= _this7.page || _this7.checkValidity(_this7.submission.data, true)) {
              _this7.setPage(i);
            }
          });
        }
    ...
    value: function buildWizardNav(nextPage) {
      ...
      [{ name: 'cancel', method: 'cancel', class: 'btn btn-default btn-secondary' }, { name: 'previous', method: 'prevPage', class: 'btn btn-default btn-secondary' }, { name: 'next', method: 'nextPage', class: 'btn btn-default btn-secondary' }, { name: 'submit', method: 'submit', class: 'btn btn-primary' }].forEach(function (button) {
