...
exports.default = [{
  ...
  conditional: {
    json: {
      and: [{ '!==': [{ var: 'data.dataSrc' }, 'values'] }, { '!==': [{ var: 'data.dataSrc' }, 'custom'] }]
    }
  },
  clearOnHide: false,
  logic: [{
    trigger: {
      type: 'json',
      json: {
        or: [{ '===': [{ var: 'data.dataSrc' }, 'values'] }, { '===': [{ var: 'data.dataSrc' }, 'custom'] }]
      }
    },
    actions: [{ type: 'clear' }]
  }]
  ...
  logic: [{
    trigger: {
      type: 'json',
      json: {
        and: [{ '!==': [{ var: 'data.dataSrc' }, 'url'] }, { '!==': [{ var: 'data.dataSrc' }, 'resource'] }]
      }
    },
    actions: [{ type: 'clear' }]
  }]
  ...
  logic: [{
    trigger: {
      type: 'json',
      json: {
        and: [{ '!==': [{ var: 'data.dataSrc' }, 'url'] }, { '!==': [{ var: 'data.dataSrc' }, 'resource'] }, { '!==': [{ var: 'data.dataSrc' }, 'json'] }]
      }
    },
    actions: [{ type: 'clear' }]
  }]
