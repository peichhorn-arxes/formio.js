...
function (_BaseComponent) {
  ...
  _createClass(SelectComponent, [{
    ...
    value: function setValue(value, flags, data) {
      ...
      var updateEventAllowed = !(flags && flags.noUpdateEvent); // Determine if we need to perform an initial lazyLoad api call if searchField is provided.
