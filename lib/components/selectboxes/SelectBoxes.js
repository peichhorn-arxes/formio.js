...
function (_RadioComponent) {
  ...
  _createClass(SelectBoxesComponent, [{
    ...
    value: function setValue(value, flags) {
      ...
      if (this.inputsReady) {
        this.inputsReady.then(function () {
          return _this2._setValue(value, flags);
        });
      } else {
    ...
    key: "_setValue",
    value: function _setValue(value, flags) {
      value = value || {};
    ...
    key: "emptyValue",
    get: function get() {
      return (0, _lodash.default)(this.component.values || []).reduce(function (prev, value) {
