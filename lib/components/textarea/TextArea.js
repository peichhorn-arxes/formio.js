...
function (_TextFieldComponent) {
  ...
  _createClass(TextAreaComponent, [{
    ...
    value: function createInput(container) {
      ...
      this.errorContainer = container; // Add the input.

      var inputContainer = this.ce('div', {
    ...
    value: function enableWysiwyg() {
      ...
      this.editorReady = this.addQuill(this.input, this.component.wysiwyg, function () {
        ...
        if (_this3.component.hasOwnProperty('spellcheck')) {
    ...
    value: function hasChanged(before, after) {
      return _get(_getPrototypeOf(TextAreaComponent.prototype), "hasChanged", this).call(this, before, after);
    }
  }, {
    key: "isEmpty",
