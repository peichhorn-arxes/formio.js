...
function (_BaseComponent) {
  ...
  _createClass(NestedComponent, [{
    ...
    key: "setNestedValue",
    value: function setNestedValue(component, value, flags, changed, data) {
      if (!data) {
        data = value;
      }
      ...
      if (component.type === 'components') {
        ...
        return component.setValue(_lodash.default.get(value, component.key), flags, data) || changed;
      } else {
    ...
    value: function setValue(value, flags, data) {
      ...
      return this.getComponents().reduce(function (changed, component) {
        return _this8.setNestedValue(component, value, flags, changed, data);
      }, false);
    }
  }, {
