  ...
  _createClass(Tagpad, [{
    ...
    value: function renderTagpad() {
      ...
      this.on('initialized', function () {
        _this2.backgroundReady.promise.then(function () {
    ...
    value: function renderForm() {
      ...
      (0, _utils.eachComponent)(this.component.components, function (component) {
        ...
        _this3.components.push(componentInstance);

        _this3.form.appendChild(componentInstance.getElement());
      });
    ...
    value: function stretchDrawingArea() {
      ...
      var height = this.background.offsetHeight; //will need dimensions multiplier for coordinates calculation
    ...
    value: function addBackground() {
      ...
      if (this.component.image) {
        ...
        _Formio.default.makeStaticRequest(this.component.imageUrl, 'GET', null, {
          ...
          console.warn("Tagpad background didn't load for component: ".concat(_this5.component.key));
